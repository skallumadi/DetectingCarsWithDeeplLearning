...
class ImageClassifier:
    def __init__(self, CNNPath, modelfilename):
        self.network_path = CNNPath
        self.caffemodelpath = CNNPath + '/' + modelfilename
        self.deployfilepath = CNNPath + '/' + 'deploy.prototxt'
        self.labelsfilepath = CNNPath + '/' + 'labels.txt'

        self.net = self.get_net(self.caffemodelpath, self.deployfilepath)
        self.transformer = self.get_transformer(self.deployfilepath)
        self.labels = self.read_labels(self.labelsfilepath)
    ...
    def classify(self, image_files,
        ...
        # make sure the given image_files is a list, or else everything breaks
...
class ImageProcessor:
    def __init__(self, networkArchive, parkingLot):
        #self.classifier = ImageClassifier(networkDirectory, modelName)
        self.classifier = image_classify(networkArchive)
...
if __name__ == '__main__':
    ...
    ic = image_classify('/home/alloba/Trained_Models/test_cars.tar.gz')
