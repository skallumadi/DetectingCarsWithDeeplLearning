#this is to contain the example code that was pulled from the nvidia digits files
...
os.environ['GLOG_minloglevel'] = '2'  # suppress caffe output
from caffe.proto import caffe_pb2


class ImageClassifier:
    def __init__(self, CNNArchivePath):
        self.archive_path = CNNArchivePath
    ...
    def classify_with_archive(self, archive, image_files, batch_size=None, use_gpu=True):
        ...
        self.classify(caffemodel, deploy_file, image_files,
                 mean_file=mean_file, labels_file=labels_file,
                 batch_size=batch_size, use_gpu=use_gpu)

        pass

    def classify(self, caffemodel, deploy_file, image_files, mean_file=None, labels_file=None, batch_size=None,use_gpu=True):
        """
