...
class App:
    ...
    def create_rectangle(self, events):
        ...
        box = np.int0(box) #some numpy nonsense. required to work, dunno what it does though. Jes: I belive it converts from double to integer points
        ...
        global tempCoordinate
        tempCoordinate = list(coord_list)
...
if __name__ == "__main__":
    #image = cv2.imread("ParkingLot.jpg", cv2.IMREAD_COLOR)
