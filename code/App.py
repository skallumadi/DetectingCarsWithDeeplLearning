...
class SetupApp(tk.Frame):
    def __init__(self, root, image_path, PKLot):
        ...
        self.canvas = self.CanvasArea(root, self.parkinglot, image_path, (800, 600))
        self.canvas.grid(row=0, column=0, sticky=tk.N)

        # Parking Spot List
        self.parkingspot_listbox = self.SpotList(self.window, self.parkinglot, width=20, height=30)
